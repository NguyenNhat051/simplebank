...
func TestGetUser(t *testing.T) {
	...
	require.WithinDuration(t, user.PasswordChangedAt, user2.PasswordChangedAt, time.Millisecond)
	require.WithinDuration(t, user.CreatedAt, user2.CreatedAt, time.Millisecond)
}
